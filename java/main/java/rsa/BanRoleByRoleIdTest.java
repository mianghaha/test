...
public class BanRoleByRoleIdTest {
public static void main(String[] args){
		
		Map<String, Object> data = new HashMap<>();
		Map<String, Object> param = new HashMap<>();
		param.put("roleid", 12345L);
		param.put("serverid", 4101);
		...
		try {
			...
			String result = HttpClientUtil.invokePost("http://127.0.1.1:8080/gmplatform/service/banrolebyroleid", content, "UTF-8", 10000, 0);
